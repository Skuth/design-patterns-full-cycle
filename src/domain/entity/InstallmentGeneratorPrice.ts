...
export default class InstallmentGeneratorPrice implements InstallmentGenerator {
  generator(loanCode: string, loanAmount: number, loanPeriod: number, loanRate: number): Installment[] {
